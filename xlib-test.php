<?php
/*
This example shows how to use Xlib framework. It drawing watching eyes, without any widget framework like GTK or Qt, only pure X.
Please keep in mind, to use it on desktop, your PHP version should be compiled --with-freetype
*/
require 'Xlib.php';
